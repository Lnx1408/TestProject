...
<main class="main container" id="main">
    <div class="my-games-container">
        ...
        <div class="games-header">
            <h1 class="page-title">Agregar Estudiantes Revisores</h1>
            <div class="games-stats">
                <div class="stat-card">
                    <i class='bx ri-file-list-3-line'></i>
                    <div class="stat-info">
                        <p class="stat-label">Partidas de Clasificación</p>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <p class="stat-label">Partidas de Construcción</p>
        ...
        <div class="games-sections">
            ...
            <section class="games-section" id="classificationGames">
                <div class="section-header">
                    <h2>Partidas de Clasificación</h2>
            ...
            <section class="games-section" id="constructionGames">
                <div class="section-header">
                    <h2 >Partidas de Construcción</h2>
